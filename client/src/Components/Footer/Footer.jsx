...
function Footer() {
  return (
    <footer>
    <div style={{ backgroundColor: '#3B455A' }}>
        <div className='container px-20'>
            <div className="pt-16 pb-20  flex flex-wrap md:flex-nowrap justify-between  " >
                ...
                <div  className=' w-full md:w-1/3 '>
                    ...
                    <ul>
                        <li className='pt-3 text-custom-color hover:text-white hover:underline' ><a href="/"  >how it works</a></li>
                        <li className='text-custom-color hover:text-white hover:underline'><a href="/">Terms of Service</a></li>
                        <li className='text-custom-color hover:text-white hover:underline'><a href="/">Privacy policy</a></li>
                    </ul>
                </div>
                <div className=' w-full md:w-1/3'>
